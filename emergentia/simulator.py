...
class PhysicsSim:
    def __init__(self, n=4, dim=2, potential=None, seed=None, device=None, use_neighbor_list=False, cutoff=None):
        if seed is not None:
    ...
    def _compute_forces_neighbor_list(self, pos):
